  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: position at top with margin, scroll content
        "top-[env(safe-area-inset-top,20px)] translate-y-0 max-h-[calc(100vh-env(safe-area-inset-top,20px)-env(safe-area-inset-bottom,20px)-40px)] overflow-y-auto",
